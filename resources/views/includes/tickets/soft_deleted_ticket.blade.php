                ...
                <form action="{{ route('ticket.update', $item->id) }}" method="post">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <label class="mt-3" for="#">{{ __('Priority') }}
                            @if (count($priority) == 0)
                                <span style="color:#8b8989; font-size:13px">({{ __('If do not have priority, then create a priority') }}) | <a href="{{ route('priority.index') }}" style="text-decoration: none"> create priority </a></span>
                            @endif
                        </label>
