            ...
            <div class="current_tickets_heading d-sm-flex justify-content-between mt-5 mb-0">
                ...
                <div class="current_tickets_heading__right d-flex align-items-center">
                    <div class="input-group mb-3 me-2">
                        ...
                        <input type="text" id="search_tickets" class="form-control border-0" placeholder="Search Tickets.."  name="Search Keyword">
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                {{-- <div class="col-md-3"> --}}
                                    ...
                                    {{-- <button type="submit" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#import_ticket_excel">{{ __('Import Excel') }}</button>
                                    <button type="submit" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#import_ticket_csv">{{ __('Import Csv') }}</button> --}}
                                {{-- </div> --}}
                                <div class="col-12 ticket_export_delete d-none">
                                    ...
                                    {{-- <form action="{{ route('export.ticket.excel') }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                        @csrf
                                        <input type="hidden" name="ticket_id" class="export_selected_ticket">
                                        <button type="submit" class="btn btn-info btn-sm">{{ __('Export Excel') }}</button>
                                    </form>

                                    <form action="{{ route('export.ticket.pdf') }}" method="POST" enctype="multipart/form-data" class="d-inline" target="_blank">
                                        @csrf
                                        <input type="hidden" name="ticket_id" class="export_selected_ticket">
                                        <button type="submit" class="btn btn-warning btn-sm">{{ __('Export Pdf') }}</button>
                                    </form>

                                    <form action="{{ route('export.ticket.csv') }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                        @csrf
                                        <input type="hidden" name="ticket_id" class="export_selected_ticket">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>
                                                ...
                                                {{-- <div>
                                                    <input type="checkbox" class="check_all" name="check_all" id="check_all" style="cursor: pointer">
